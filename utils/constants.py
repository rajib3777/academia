...
BANGLADESH_UPAZILAS = [
    ...
    ('Atwari', 'Atwari'),
    ('Austagram', 'Austagram'),
    ('Azmiriganj', 'Azmiriganj'),
    ('B.Baria-S', 'B.Baria-S'),
    ('Babuganj', 'Babuganj'),
    ('Badalgachi', 'Badalgachi'),
    ('Badarganj', 'Badarganj'),
    ('Bagatipara', 'Bagatipara'),
    ('Bagerhat-S', 'Bagerhat-S'),
    ('Bagha', 'Bagha'),
    ...
    ('Bandar', 'Bandar'),
    ('Bandarban-S', 'Bandarban-S'),
    ('Baniachong', 'Baniachong'),
    ('Banskhali', 'Banskhali'),
    ('Baraigram', 'Baraigram'),
    ('Barguna-S', 'Barguna-S'),
    ('Barhatta', 'Barhatta'),
    ('Barishal-S', 'Barishal-S'),
    ('Barkal', 'Barkal'),
    ('Barlekha', 'Barlekha'),
    ('Barura', 'Barura'),
    ('Basail', 'Basail'),
    ...
    ('Burichong', 'Burichong'),
    ('Chakoria', 'Chakoria'),
    ('Chandanish', 'Chandanish'),
    ('Chandina', 'Chandina'),
    ('Chandpur-S', 'Chandpur-S'),
    ...
    ('Chowgacha', 'Chowgacha'),
    ('Chowhali', 'Chowhali'),
    ('Chuadanga-S', 'Chuadanga-S'),
    ('Chunarughat', 'Chunarughat'),
    ('Companiganj', 'Companiganj'),
    ('Companiganj', 'Companiganj'),
    ("Cox'S Bazar-S", "Cox'S Bazar-S"),
    ('Cumilla-S', 'Cumilla-S'),
    ('Cumilla-S Daksin', 'Cumilla-S Daksin'),
    ('Dacope', 'Dacope'),
    ('Daganbhuiyan', 'Daganbhuiyan'),
    ('Dakhin Sunamganj', 'Dakhin Sunamganj'),
    ...
    ('Dhobaura', 'Dhobaura'),
    ('Dhunot', 'Dhunot'),
    ('Dhupchancia', 'Dhupchancia'),
    ('Dighalia', 'Dighalia'),
    ('Dighinala', 'Dighinala'),
    ('Dimla', 'Dimla'),
    ('Dinajpur-S', 'Dinajpur-S'),
    ('Doarabazar', 'Doarabazar'),
    ('Dohar', 'Dohar'),
    ('Domar', 'Domar'),
    ('Dumki', 'Dumki'),
    ('Dumuria', 'Dumuria'),
    ...
    ('Jaldhaka', 'Jaldhaka'),
    ('Jamalganj', 'Jamalganj'),
    ('Jamalpur-S', 'Jamalpur-S'),
    ('Janjira', 'Janjira'),
    ('Jashore-S', 'Jashore-S'),
    ('Jhalokathi-S', 'Jhalokathi-S'),
    ('Jhenaidah-S', 'Jhenaidah-S'),
    ('Jhenaigati', 'Jhenaigati'),
    ('Jhikargacha', 'Jhikargacha'),
    ('Jibannagar', 'Jibannagar'),
    ('Jointiapur', 'Jointiapur'),
    ('Joypurhat-S', 'Joypurhat-S'),
    ...
    ('Keshabpur', 'Keshabpur'),
    ('Khagrachari-S', 'Khagrachari-S'),
    ('Khaliajuri', 'Khaliajuri'),
    ('Khanshama', 'Khanshama'),
    ('Khetlal', 'Khetlal'),
    ('Khoksha', 'Khoksha'),
    ('Kishoreganj', 'Kishoreganj'),
    ('Kishoreganj-S', 'Kishoreganj-S'),
    ('Koira', 'Koira'),
    ('Komol Nagar', 'Komol Nagar'),
    ('Kotchandpur', 'Kotchandpur'),
    ('Kotwalipara', 'Kotwalipara'),
    ('Kulaura', 'Kulaura'),
    ('Kuliarchar', 'Kuliarchar'),
    ('Kumarkhali', 'Kumarkhali'),
    ('Kurigram-S', 'Kurigram-S'),
    ('Kushtia-S', 'Kushtia-S'),
    ('Kutubdia', 'Kutubdia'),
    ('Lakhai', 'Lakhai'),
    ('Laksham', 'Laksham'),
    ('Lalmai', 'Lalmai'),
    ('Lalmohan', 'Lalmohan'),
    ('Lalmonirhat-S', 'Lalmonirhat-S'),
    ('Lalpur', 'Lalpur'),
    ('Lama', 'Lama'),
    ('Langadu', 'Langadu'),
    ('Lauhajong', 'Lauhajong'),
    ('Laxmichari', 'Laxmichari'),
    ('Laxmipur-S', 'Laxmipur-S'),
    ('Lohagara', 'Lohagara'),
    ('Lohagara', 'Lohagara'),
    ('Madan', 'Madan'),
    ('Madarganj', 'Madarganj'),
    ('Madaripur-S', 'Madaripur-S'),
    ('Madhabpur', 'Madhabpur'),
    ...
    ('Monohardi', 'Monohardi'),
    ('Monohorganj', 'Monohorganj'),
    ('Monpura', 'Monpura'),
    ('Morrelganj', 'Morrelganj'),
    ('Mothbaria', 'Mothbaria'),
    ('Moulvibazar-S', 'Moulvibazar-S'),
    ('Mujib Nagar', 'Mujib Nagar'),
    ('Muksudpur', 'Muksudpur'),
    ('Muktagacha', 'Muktagacha'),
    ('Muladi', 'Muladi'),
    ('Munshiganj-S', 'Munshiganj-S'),
    ('Muradnagar', 'Muradnagar'),
    ('Mymensingh-S', 'Mymensingh-S'),
    ('Nabiganj', 'Nabiganj'),
    ('Nabinagar', 'Nabinagar'),
    ('Nachol', 'Nachol'),
    ...
    ('Naogaon-S', 'Naogaon-S'),
    ('Narail-S', 'Narail-S'),
    ('Narayanganj-S', 'Narayanganj-S'),
    ('Naria', 'Naria'),
    ('Narshingdi-S', 'Narshingdi-S'),
    ('Nasirnagar', 'Nasirnagar'),
    ('Natore-S', 'Natore-S'),
    ('Nawabganj', 'Nawabganj'),
    ('Nawabganj', 'Nawabganj'),
    ('Nawabganj-S', 'Nawabganj-S'),
    ('Nazirpur', 'Nazirpur'),
    ('Nesarabad', 'Nesarabad'),
    ('Netrakona-S', 'Netrakona-S'),
    ('Niamatpur', 'Niamatpur'),
    ('Nikli', 'Nikli'),
    ('Nilphamari-S', 'Nilphamari-S'),
    ('Noakhali-S', 'Noakhali-S'),
    ...
    ('Ramu', 'Ramu'),
    ('Rangabali', 'Rangabali'),
    ('Rangamati-S', 'Rangamati-S'),
    ('Rangpur-S', 'Rangpur-S'),
    ('Rangunia', 'Rangunia'),
    ('Raninagar', 'Raninagar'),
    ('Ranisankail', 'Ranisankail'),
    ('Raojan', 'Raojan'),
    ('Rowangchari', 'Rowangchari'),
    ('Rowmari', 'Rowmari'),
    ('Ruma', 'Ruma'),
    ('Rupganj', 'Rupganj'),
    ('Rupsa', 'Rupsa'),

...
dropdown_urlpatterns = [
    path('payments/methods/', views.PaymentMethodDropdownView.as_view(), name='payment-method-dropdown'),
    path('payments/statuses/', views.PaymentStatusDropdownView.as_view(), name='payment-status-dropdown'),
]
